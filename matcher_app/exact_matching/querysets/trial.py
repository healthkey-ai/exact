...
from exact_matching.constants import TRIAL_SCORE_MAX
...
from exact_matching.user_to_trial_attrs_mapper import UserToTrialAttrsMapper
...
class TrialQuerySet(models.QuerySet):
    ...
    def with_goodness_score_optimized(self,
        ...
        from exact_matching.utils import normalize_goodness_weights
